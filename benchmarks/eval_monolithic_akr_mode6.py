...
OUTPUT_FILE = "/home/cune/llama.cpp/benchmarks/monolithic_akr_mode6_benchmark_results.json"

CONFIG = {
    "id": "monolithic_akr_mode6_t2",
    "name": "Monolithic AKR (Mode 6, L=14, g=0.0331, T=2)",
    "layer": 14,
    "gamma": 0.0331,
    "mode": 6,
    "t": 2
